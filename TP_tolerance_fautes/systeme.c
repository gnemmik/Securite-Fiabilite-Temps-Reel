...
{ 
  ...
  pthread_create(simulateur,NULL,(void *)env_simu_systeme, NULL);
  th_afficheur=(pthread_t *)malloc(sizeof(pthread_t));
  pthread_create(th_afficheur,NULL,(void *)env_afficheur, NULL);
